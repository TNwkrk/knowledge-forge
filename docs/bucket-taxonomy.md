...
| `document_type` | `document.document_type` | `honeywell/dc1000/document-type` | `service-manual` | Separates manuals, bulletins, procedures, drawings, and guides |
| `document_class` | `document.document_class` | `honeywell/dc1000/document-class` | `authoritative-technical` | Broad source-family grouping used alongside `document_type` |
...
| `honeywell/dc1000/document-class` | `document_class` | `authoritative-technical` |
